...
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QGroupBox, QFrame
...
class CalibrationResultsDisplay(QWidget):
    ...
    def _create_status_widget(self) -> QWidget:
        ...
        self.recalibrate_label.linkActivated.connect(lambda: self.recalibrate_requested.emit())
