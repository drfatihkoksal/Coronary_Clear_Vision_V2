...
class QCAProgressIndicator(QWidget):
    ...
    def show_progress(self, message: str = "Initializing analysis...", 
    ...
    def update_sequential_progress(self, current_frame: int, total_frames: int,
                                 current_status: str = "Analyzing..."):
        """
        ...
        self.sequential_info_label.setText(
            f"Sequential Analysis: {percent:.0f}% Complete"
        )
