...
class OverlayItem(QGraphicsItem):
    ...
    def paint(self, painter: QPainter, option, widget):
        ...
        if (
            self.calibration_centerline is not None
        ...
        if (
            ...
            and self.segmentation_settings.get("enabled", False)
            and self.show_segmentation
        ):
    ...
    def _draw_diameter_line(
        self, painter: QPainter, index: int, centerline: list, results: dict
    ) -> bool:
        ...
        if (
            ...
            and index < len(results["left_edges"])
        ):
    ...
    def paint_calibration_diameters(self, painter: QPainter):
        ...
        if (
            self.calibration_centerline is None
