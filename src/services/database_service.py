...
class DatabaseService:
    ...
    def set_current_study(
        self,
        study_description: str = "Coronary Angiography",
        ...
        try:
            ...
            if all(v is not None for v in [point1_x, point1_y, point2_x, point2_y]):
                ...
                if calibration_factor > 0:
                    calibration_data.distance_mm = (
                        calibration_data.distance_pixels / calibration_factor
                    )
    ...
    def save_qca_analysis(
        ...
        try:
            ...
            logger.info(
                f"Saved QCA analysis for vessel {vessel.value} frame {frame_number}: {analysis_id}"
            )
            return analysis_id
