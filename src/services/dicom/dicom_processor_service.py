...
from src.domain.models.dicom_models import (
    DicomFrame, DicomSeries, DicomWindowLevel,
    DicomPixelSpacing
)
from src.domain.interfaces.dicom_interfaces import (
    IDicomPixelProcessor, IDicomFrameExtractor
)
    ...
    def resize_frame(self,
        ...
        try:
            ...
            if preserve_aspect:
                ...
                # Yeniden boyutlandır
                resized = cv2.resize(pixel_array, (new_width, new_height), 
                ...
                resized = cv2.resize(pixel_array, target_size,
                                   interpolation=cv2.INTER_LINEAR)
                return resized
