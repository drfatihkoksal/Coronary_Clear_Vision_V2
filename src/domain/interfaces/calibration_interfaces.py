...
class ICalibrationPersistence(Protocol):
    ...
    def save_calibration(self, calibration: CalibrationResult, study_id: str) -> bool:
        """
        Kalibrasyonu saklar.
...
class ICalibrationVisualization(Protocol):
    ...
    def visualize_calibration(
        self, image: np.ndarray, calibration: CalibrationResult
    ) -> np.ndarray:
        """
    ...
    def draw_catheter_overlay(
        self, image: np.ndarray, measurement: CatheterMeasurement
    ) -> np.ndarray:
        """
