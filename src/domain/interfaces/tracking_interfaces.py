...
from src.domain.models.tracking_models import (
    TrackingResult, TrackingRequest, TrackedPoint, TrackingFrame,
...
class ITrackingSessionManager(Protocol):
    ...
    def create_session(self,
                      start_frame: int,
                      parameters: TrackingParameters) -> TrackingSession:
        """
...
class ITrackerFactory(Protocol):
    ...
    def create_tracker(self,
                      method: str,
                      parameters: Dict[str, Any]) -> ITracker:
        """
        İzleyici oluşturur.
