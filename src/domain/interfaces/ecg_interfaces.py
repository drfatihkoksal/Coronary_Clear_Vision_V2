...
class IRPeakDetector(Protocol):
    ...
    @abstractmethod
    def refine_peaks(self, signal: ECGSignal, initial_peaks: List[int]) -> List[RPeak]:
        """
    ...
    @abstractmethod
    def calculate_confidence(self, signal: ECGSignal, peaks: List[RPeak]) -> List[float]:
        """
...
class IECGVisualizer(Protocol):
    ...
    def create_signal_plot(
        ...
        phases: Optional[CardiacPhaseAnalysis] = None,
    ) -> Any:
        """
...
class IECGExporter(Protocol):
    ...
    @abstractmethod
    def export_to_csv(self, analysis_result: ECGAnalysisResult, output_path: str) -> bool:
        """
    ...
    @abstractmethod
    def export_to_json(self, analysis_result: ECGAnalysisResult, output_path: str) -> bool:
        """
